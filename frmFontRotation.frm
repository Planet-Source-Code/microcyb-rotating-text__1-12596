...
Begin VB.Form frmFontRotation 
   ...
   ForeColor       =   &H000000FF&
   LinkTopic       =   "Form1"
   Picture         =   "frmFontRotation.frx":0000
   ScaleHeight     =   238
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   637
...
Const TEXTOUTPUT As String = "Microcyb"
...
Const p_WIDTH As Long = 20
Const p_HEIGHT As Long = 70
...
Private Sub RunMain()
Const FrameInterval As Long = 70
